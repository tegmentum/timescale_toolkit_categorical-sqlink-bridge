...
const PROVIDER_ID: &str = "timescale_toolkit_categorical-composed";
...
fn scalar_name_by_id(id: u64) -> Option<&'static str> {
    match id {
        ...
        9 => Some("low"),
        10 => Some("low_time"),
        11 => Some("max_frequency"),
        12 => Some("min_frequency"),
        13 => Some("num_gaps"),
        14 => Some("num_live_ranges"),
        15 => Some("open"),
        16 => Some("open_time"),
        17 => Some("state_at"),
        18 => Some("state_at_int"),
        19 => Some("uptime"),
        20 => Some("volume"),
        21 => Some("vwap"),
        _ => None,
...
impl MetadataGuest for Component {
    fn describe() -> Manifest {
        let scalar_functions: Vec<ScalarFunctionSpec> = vec![
            ...
            ScalarFunctionSpec {
                id: 4,
                name: "downtime".to_string(),
                num_args: -1,
                func_flags: FunctionFlags::DETERMINISTIC,
            },
            ScalarFunctionSpec {
                id: 5,
                name: "duration_in".to_string(),
                num_args: -1,
                func_flags: FunctionFlags::DETERMINISTIC,
            },
            ScalarFunctionSpec {
            ...
            ScalarFunctionSpec {
                id: 7,
                name: "high_time".to_string(),
                num_args: -1,
                func_flags: FunctionFlags::DETERMINISTIC,
            },
            ScalarFunctionSpec {
                id: 8,
                name: "live_at".to_string(),
                num_args: -1,
                func_flags: FunctionFlags::DETERMINISTIC,
            },
            ScalarFunctionSpec {
            ...
            ScalarFunctionSpec {
                id: 12,
                name: "min_frequency".to_string(),
                num_args: -1,
                func_flags: FunctionFlags::DETERMINISTIC,
            },
            ScalarFunctionSpec {
                id: 13,
                name: "num_gaps".to_string(),
                num_args: -1,
                func_flags: FunctionFlags::DETERMINISTIC,
            },
            ScalarFunctionSpec {
                id: 14,
                name: "num_live_ranges".to_string(),
                num_args: -1,
                func_flags: FunctionFlags::DETERMINISTIC,
            },
            ScalarFunctionSpec {
            ...
            ScalarFunctionSpec {
                id: 17,
                name: "state_at".to_string(),
                num_args: -1,
                func_flags: FunctionFlags::DETERMINISTIC,
            },
            ScalarFunctionSpec {
                id: 18,
                name: "state_at_int".to_string(),
                num_args: -1,
                func_flags: FunctionFlags::DETERMINISTIC,
            },
            ScalarFunctionSpec {
        ...
        let aggregate_functions: Vec<AggregateFunctionSpec> = vec![
            AggregateFunctionSpec {
                id: 1000000,
                name: "candlestick_agg".to_string(),
                num_args: -1,
            ...
            AggregateFunctionSpec {
                id: 1000001,
                name: "compact_state_agg".to_string(),
                num_args: -1,
                func_flags: FunctionFlags::empty(),
                is_window: false,
            },
        ...
        let vtabs: Vec<VtabSpec> = vec![
            ...
            VtabSpec {
                id: 2000001,
                name: "into_int_values".to_string(),
                eponymous: true,
                mutable: false,
                batched: false,
            },
            ...
            VtabSpec {
                id: 2000003,
                name: "state_int_timeline".to_string(),
                eponymous: true,
                mutable: false,
                batched: false,
            },
...
fn aggregate_name_by_id(id: u64) -> Option<&'static str> {
    match id {
        1000000 => Some("candlestick_agg"),
        1000001 => Some("compact_state_agg"),
        1000002 => Some("freq_agg"),
        1000003 => Some("heartbeat_agg"),
        1000004 => Some("max_n"),
        1000005 => Some("max_n_by"),
        1000006 => Some("mcv_agg"),
        1000007 => Some("min_n"),
        1000008 => Some("min_n_by"),
        1000009 => Some("state_agg"),
        _ => None,
    }
}
...
fn vtab_name_by_id(id: u64) -> Option<&'static str> {
    match id {
        2000000 => Some("dead_ranges"),
        2000001 => Some("into_int_values"),
        2000002 => Some("live_ranges"),
        2000003 => Some("state_int_timeline"),
        2000004 => Some("state_periods"),
        2000005 => Some("state_timeline"),
        2000006 => Some("topn"),
        _ => None,
    }
}
...
impl VtabGuest for Component {
    ...
    fn connect(
        ...
        match vtab_id {
                ...
                2000002 => Ok("CREATE TABLE x(\"result\" BLOB, \"_arg0\" HIDDEN)".to_string()),
                2000003 => Ok("CREATE TABLE x(\"result\" BLOB, \"_arg0\" HIDDEN)".to_string()),
                2000004 => Ok("CREATE TABLE x(\"result\" BLOB, \"_arg0\" HIDDEN, \"_arg1\" HIDDEN)".to_string()),
                2000005 => Ok("CREATE TABLE x(\"result\" BLOB, \"_arg0\" HIDDEN)".to_string()),
                2000006 => Ok("CREATE TABLE x(\"result\" BLOB, \"_arg0\" HIDDEN, \"_arg1\" HIDDEN, \"_arg2\" HIDDEN)".to_string()),

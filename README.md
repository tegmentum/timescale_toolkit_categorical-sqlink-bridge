# timescale_toolkit_categorical × sqlink bridge (Phase 9.2, timescaledb)

Auto-generated by [`sqlink-shim-codegen`](https://github.com/tegmentum/sqlink-shim-codegen)
via `--dynlink --target timescale_toolkit_categorical --provider-id timescale_toolkit-composed`.
...
timescale_toolkit_categorical=$(pwd)/target/wasm32-wasip2/release/timescale_toolkit_categorical_sqlite_bridge_dynlink.wasm"
...
timescale_toolkit_categorical=timescale_toolkit"

sqlink -c "LOAD timescale_toolkit_categorical;"
```
